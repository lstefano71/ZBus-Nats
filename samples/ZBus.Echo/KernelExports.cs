...
public static unsafe class KernelExports
{
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_init &lt;0T1 >Z'
    /// APL: (rc rootName) ← init 'MyBus' 0
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_wait&amp; &lt;0T1 I4 >Z >Z >Z'
    /// APL: (rc obj evt data) ← wait 'MyBus' 5000 0 0 0
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_close &lt;0T1'
    /// APL: rc ← close ⊂'MyBus.T1'
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_names &lt;0T1 >Z'
    /// APL: (rc children) ← names 'MyBus' 0
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_exists &lt;0T1'
    /// APL: rc ← exists ⊂'MyBus.T1'  (0=exists, NotFound=doesn't)
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_getprop &lt;0T1 &lt;0T1 >Z'
    /// APL: (rc value) ← getprop 'MyBus.T1' 'Interval' 0
    /// </summary>
    ...
    /// ⎕NA: 'I4 ZBus.Echo|zbus_setprop &lt;0T1 &lt;0T1 =Z'
    /// APL: rc ← setprop 'MyBus.T1' 'Interval' (⊂1000)
    /// </summary>
